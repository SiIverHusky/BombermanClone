...
function initializeGame(data) {
	...
	tilemap = data.tilemap;
	items = data.items;
	player1 = data.players.find(player => player.color === "red");
	player2 = data.players.find(player => player.color === "blue");
...
function inputHandler(event) {
    ...
    if (!currentPlayer.latestKey) {
        currentPlayer.latestKey = null;
    }
